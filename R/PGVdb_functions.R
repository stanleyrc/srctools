...
bw_temp = function(patient_id = NA, x = list(NA), ref = NA, chart_type = "area", visible = TRUE, type = "bigwig", field = "foreground") {
...
arrow_temp = function(patient_id = NA, x = list(NA), ref = NA, chart_type = "scatterplot", visible = TRUE, type = "scatterplot", field = "foreground") {
    dt1 = data.table(patient.id = patient_id,
                     visible = visible,
                     x = x,
                     type = type,
...
genome_temp = function(patient_id = NA, x = list(NA), ref = NA, type = "genome", visible = TRUE) {
...
walks_temp = function(patient_id = NA, x = list(NA), ref = NA, type = "genome", visible = TRUE) {
    dt1 = data.table(patient.id = patient_id, 
                                          visible = visible,
                                          x = list(NA),
                                          ref = ref
